...
public class ListDatabaseServersEndpoint(IYaverContext yaverContext)
    : ListDatabaseServersEndpointBase<ListDatabaseServersMapper> {
...
public class ListDatabaseServersMapper
