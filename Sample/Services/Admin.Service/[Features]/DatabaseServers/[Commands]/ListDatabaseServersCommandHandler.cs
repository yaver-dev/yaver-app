...
public sealed class ListDatabaseServersCommandHandler(ServiceDbContext db)
  : ICommandHandler<ListDatabaseServersCommand, DatabaseServerListResult>
{

  public async Task<DatabaseServerListResult> ExecuteAsync(ListDatabaseServersCommand command, CancellationToken ct)
  {
    #region filter
