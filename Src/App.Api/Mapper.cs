...
public abstract class YaverMapper<TRequest, TResponse, TCommand, TResult> : IMapper { //, IServiceResolverBase where TRequest : notnull where TResponse : notnull {
  ...
  public virtual TCommand ToCommand(TRequest r) => throw new NotImplementedException($"Please override the {nameof(ToCommand)} method!");
  ...
  public virtual TResponse ToResponse(TResult r) => throw new NotImplementedException($"Please override the {nameof(ToResponse)} method!");
